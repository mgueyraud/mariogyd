...
export default function Home() {
  return (
    <>
      ...
      <h2 className="font-light mt-1 text-gray-300">Senior Front-End & Design Engineer</h2>
      <p className="mt-7 font-light text-gray-300">
      ...
      <h2 className="font-semibold mt-16">Lab</h2>
      ...
      <div className="flex gap-2 mt-4 font-light text-gray-300">
